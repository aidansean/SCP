...
?>
  <div class="right">
    ...
    <h3>Special Containment Procedures</h3>
      ...
      <p>SCP-1405-1 is to be kept in a fireproof safe when not being tested. Staff must wear gloves and long sleeves/trousers when handling SCP-1405-1. Face masks are also recommended. Personnel are not allowed to bring any small items into the same room as SCP-1405 and are not allowed to wear clothes with pockets when in the same room as SCP-1405.</p>
      
      <p>SCP-1405-[2-32] are to kept in separate fireproof safes and are to checked once a week by Class D Personnel wearing fireproof protective clothing. SCP-1405-5 and SCP-1405-13, which are too large to be contained in a fireproof safe, are to be kept in locked storage rooms fitted with fire doors and smoke alarms. At least two working fire extinguishers must be kept in good working order and placed alongside the storage for each of SCP-1405-[2-32]. SCP-1405-9 must be checked and maintained every day. Extreme care must be taken when checking SCP-1405-8, 1405-14 and SCP-1405-25.</p>
      ...
      <p>SCP involved:SCP-1405-1, SCP-1405-8<br />
        ...
        <p>During an early routine test SCP-1405-1 was used to mark a variety of objects. Two Class D Personnel were present for the test, before gloves became mandatory. During the test SCP-1405-1 came into contact with one of the personnel, leaving a mark on his right wrist. Three days later, while in the cafeteria of site 19 the subject experienced an intense burning pain in his right wrist radiating up his arm to his torso, which showed signs of severe burn injuries. Between ten to fifteen minutes later the hair on his body ignited, leading to the combustion of some of his clothing. He died approximately three minutes later of asphyxiation. Other staff attempted to use a fire blanket and fire extinguisher on the subject, dousing the flaming clothing, but the subject continued to burn.</p>
        
        <p>The CCTV footage of the incident has been classified and stored at █████ ████, and has been the subject of repeated study. At the time of contact with SCP-1405-1 the subject was attempting to mark SCP-1405-8, a commercial firework. SCP-1405-8 remains in storage. Class D Personnel appear reluctant to check the status of SCP-1405-8. Senior staff suspect this may relate to superstitious beliefs regarding the fate of the aforementioned subject.</p>
        ...
        <p>During routine testing Dr ██████, assisted by a member of Class D personnel was conducting tests on SCP-1405-1. To facilitate record keeping Dr ██████ asked for written notes. The Class D Personnel used SCP-1405-1 to take notes in a standard laboratory log book, which Dr ██████ collected at the end of the study. 34 days letter the notes ignited in Dr ██████'s office, causing a fire which spread across five rooms, irreparably damaging and destroying case notes amounting to approximately nine months of tests on various SCPs. The estimated cost of the damage was $██m. The fire blocked access to escape routes (with conventional fire escapes inaccessible due to security measures in the wing.) Four members of auxiliary staff died in the fire. Review of fire escapes proposed and postponed indefinitely.</p>
    </div>
  </div>
